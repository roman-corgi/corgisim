...
def generate_observation_sequence(scene, cgi_optics, cgi_detector, exp_time, n_frames, roll_angles):
    '''
    Function that generates a sequence of observations for a given scene, instrument configuration, and detector configuration. 

    - roll angles is a list that needs to match the length of n_frames.
