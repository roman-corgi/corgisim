...
def main():
    ...
    optics_keywords = {'cor_type':cor_type, 'use_errors':2, 'polaxis':10, 'output_dim':output_dim,\
                        'use_dm1':1, 'dm1_v':dm1, 'use_dm2':1, 'dm2_v':dm2,'use_fpm':0, 'use_lyot_stop':0,  'use_field_stop':0 , 'oversample_factor': 2, 'NCPUS':7}
    ...
    prf_hdu = prf_simulation.make_prf_cube(
        ...
        prf_dict=prf_dict,
        overwrite=True,
        prf_fname="prf_hlc_band_1_no_fpm_small.fits"
    )
