...
def generate_L1_data(CPGS_xml, scene_hdu, proper_arguments, emccd_detect_arguments): 
    '''
    ...
    scene_hdu: An astropy hdu that contains the scene information
    ...
    convolved_scene = proper_convolve_2d_scene(scene_hdu, proper_arguments)

    scene_with_sources = place_point_sources(convolved_scene, scene_hdu)

    scene_with_psf = generate_host_star_psf(scene_with_sources, scene_hdu, proper_arguments)
